export const enContent = {
  ...
  about: {
    ...
    facts: [
      { label: "Based in", value: "Lampang, Thailand" },
      { label: "Born", value: "28 July 2003" },
      { label: "Systems built", value: "3 (AI, CCTV, Booking)" },
      { label: "Education", value: "B.Eng Computer Eng." },
    ],
  ...
  projects: {
    ...
    allTab: "All",
    articlePrefix: "PROJECT #",
    deepDiveBtn: "Read More",
    liveSiteBtn: "Live Site",
    projectPdfBtn: "Project PDF",
    githubBtn: "GitHub",
    architectureTitle: "How it's built",
    modalOverviewTitle: "Overview",
    modalTechTitle: "Tech Used",
    modalResultsTitle: "What it does well",
  ...
  experience: {
    ...
    educationTitle: "Education & Documents",
    certificationsTitle: "Certifications",
    officialPdfsTitle: "University Documents",
    transcriptBtn: "Academic Transcript (PDF)",
    graduationCertBtn: "Graduation Cert (PDF)",
  ...
  contact: {
    ...
    messagePlaceholder: "Tell me about your project, goals, or inquiry...",
