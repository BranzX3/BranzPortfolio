...
export const thContent: typeof enContent = {
  ...
  hero: {
    ...
    introParagraph:
      "สวัสดีครับ ผมพีระพงษ์ วงศ์วิชัย (ดีโก้) จบวิศวกรรมคอมพิวเตอร์ ตอนนี้อยู่ที่ลำปางครับ ที่ผ่านมาผมทำระบบ AI Platform, CCTVMap และ Room Booking ทั้งหมดพัฒนาโดยใช้ AI coding assistant ร่วมด้วย",
    exploreWork: "ดูผลงาน",
  ...
  about: {
    ...
    bio: [
      "ผมชื่อพีระพงษ์ วงศ์วิชัย (ดีโก้) เกิดวันที่ 28 กรกฎาคม 2546 ปัจจุบันอยู่ที่จังหวัดลำปางครับ",
